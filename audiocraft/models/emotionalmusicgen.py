...
from ..modules.conditioners import ConditioningAttributes, WavCondition, EmotionCondition
...
class EmotionalMusicGen(BaseGenModel):
    ...
    def get_pretrained(name: str = 'facebook/musicgen-melody', device=None):
        ...
        return EmotionalMusicGen(name, compression_model, lm)

    def set_generation_params(
        self, use_sampling: bool = True, 
        top_k: int = 250,
        top_p: float = 0.0, 
